        ...
        <div class="grid grid-cols-1 gap-4 mb-4">
          ...
          <div class="flex items-center justify-center h-48 rounded bg-white dark:bg-gray-800">
            <div class="relative w-full overflow-x-auto shadow-md sm:rounded-lg">
                  ...
                  <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <td class="px-6 py-4">
                      <div class="w-[350px] h-[80px] overflow-y-auto">
                        <p>Taylor Alison Swift is an American singer-songwriter. Known for her biographical songwriting,
                          artistic reinventions, and cultural impact, Swift is a leading figure in popular music and the
                          subject of widespread public interest. </p>
                      </div>
                    </td>
                    <td class="px-6 py-4 text-right">
                      <button id="editSingersButton" data-modal-target="editSingersModal"
                        data-modal-toggle="editSingersModal"
              ...
              {{-- Edit modal start --}}
              <div id="editSingersModal" tabindex="-1" aria-hidden="true"
                    ...
                    <form action="#">
                      <div class="grid gap-4 mb-4 sm:grid-cols-2">
                        ...
                        <div class="sm:col-span-2">
                          ...
                          <textarea id="singerProfile" rows="4"
