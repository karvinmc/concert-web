        ...
        <div class="grid grid-cols-1 gap-4 mb-4">
                  ...
                  @foreach ($bookings as $booking)
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                      ...
                      <td class="px-6 py-4 text-right">
                        <a id="editButton" href="{{ url('admin/bookings/' . $booking->id . '/edit') }}"
                           class="px-4 font-medium text-blue-600 dark:text-blue-500 hover:underline">Edit</a>
                        <button type="button" data-modal-target="deleteModal" data-booking-id="{{ $booking->id }}"
          ...
          <div class="flex items-center justify-end rounded bg-white dark:bg-gray-800">
            <div class="flex justify-center">
              {{-- Add toggle --}}
              <button id="addButton" data-modal-target="addModal" data-modal-toggle="addModal" class="block text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button">
                Add a booking
              </button>
            </div>
                ...
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                  ...
                  <div class="p-4 md:p-5 text-center">
                    ...
                    <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Are you sure you want to delete
                      this product?</h3>
                    <form method="POST" action="{{ url('admin/bookings/' . $booking->id) }}" class="inline">
                      @csrf
                      @method('DELETE')
    ...
    $(document).ready(function() {
      ...
      deleteButtons.each(function() {
        $(this).on('click', function() {
          const bookingId = $(this).data('booking-id'); // Get the singer's ID using jQuery's .data()
          const deleteUrl = `{{ url('admin/bookings') }}/${bookingId}`; // Build the dynamic URL
