        ...
        <div class="grid grid-cols-1 gap-4 mb-4">
          <div class="flex items-center justify-start">
            <div class="relative w-full overflow-x-auto">
              <h2 class="font-bold text-2xl">Tickets Table</h2>
            </div>
          </div>
          <div class="flex items-center justify-center min-h-48 rounded bg-white dark:bg-gray-800">
            <div class="relative w-full overflow-x-auto shadow-md sm:rounded-lg">
              <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                  <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <td class="px-6 py-4 text-transform: uppercase">
                      a1
                    </td>
                    <td class="px-6 py-4 text-transform: uppercase">
                      available
                    ...
                    <td class="px-6 py-4 text-right">
                      <button id="editTiketsButton" data-modal-target="editTiketsModal"
                              data-modal-toggle="editTiketsModal"
              ...
              {{-- Edit modal start --}}
              <div id="editTiketsModal" tabindex="-1" aria-hidden="true"
                      ...
                      <div class="grid gap-4 mb-4 sm:grid-cols-2">
                        <div>
                          ...
                          <select id="concertName"
                                  ...
                                  required="">
                            <option selected="">Select a concert</option>
                            <option class="text-transform: capitalize" value="0">the eras tour</option>
                          </select>
                        </div>
                        <div>
                          <label for="seatNumber"
                                 class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Seat Number</label>
                          <input type="text" name="seatNumber" id="seatNumber"
                                 class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-600 focus:border-blue-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                 placeholder="A1, B2, C3" required="">
                        </div>
                        <div>
                          ...
                          <select id="ticketStatus"
                            ...
                            <option class="text-transform: capitalize" value="0">available</option>
                            <option class="text-transform: capitalize" value="0">booked</option>
                          </select>
                        </div>
                        <div>
          ...
          <div class="flex items-center justify-end rounded bg-white dark:bg-gray-800">
            <div class="flex justify-center">
              {{-- Add toggle --}}
              <button id="singersModalButton" data-modal-target="singersModal" data-modal-toggle="singersModal"
            ...
            {{-- Add modal start --}}
            <div id="singersModal" tabindex="-1" aria-hidden="true"
                 class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-modal md:h-full">
              <div class="relative p-4 w-full max-w-2xl h-full md:h-auto">
                {{-- Modal content --}}
                <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                  ...
                  <div
                    ...
                    <button type="button"
                            class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-600 dark:hover:text-white"
                            data-modal-toggle="singersModal">
                      <svg aria-hidden="true" class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20"
                           xmlns="http://www.w3.org/2000/svg">
                        <path fill-rule="evenodd"
                              d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z"
