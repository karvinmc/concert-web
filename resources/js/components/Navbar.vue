  ...
  <header class="bg-white">
    <nav class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
      ...
      <PopoverGroup class="hidden lg:flex lg:gap-x-12">
        ...
        <a href="#" class="text-sm/6 font-semibold text-gray-900">Concerts</a>
        <a href="#" class="text-sm/6 font-semibold text-gray-900">Singer</a>
      </PopoverGroup>
      <div class="hidden lg:flex lg:flex-1 lg:justify-end">
        <button
          class="text-sm/6 font-semibold px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-400">
          Login
        </button>
      </div>
    </nav>
